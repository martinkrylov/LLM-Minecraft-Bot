...
5. **Provide Clear Instructions**:
   ...
   - Include equiping items in your instructions.
...
Available methods and their required parameters are(THESE ARE THE METHODS YOU NEED TO COMPILE DOWN TO):
...
Each entry in the "instructions" list should represent an action, defined by two main parts: "method" and "parameters". The "method" specifies the action to be performed, while "parameters" provides any necessary details for that action (such as coordinates, item names, or other relevant properties).
